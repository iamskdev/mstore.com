> **DOCUMENT AUDIT**
> - **Status:** `Up-to-Date`
> - **Last Reviewed:** August 17, 2025, 8:00 PM IST
> - **Reviewer:** Gemini
...
## हाल के परिवर्तन (Recent Changes) - August 17, 2025
...
1.  **प्रारंभ (`index.html` और `app-loader.js`):**
    -   ऐप `index.html` से शुरू होता है, जिसमें UI के लिए प्लेसहोल्डर होते हैं और यह केवल एक स्क्रिप्ट, `app-loader.js`, को लोड करता है।
    -   `app-loader.js` ऐप का मुख्य ऑर्केस्ट्रेटर है। यह सही क्रम में सब कुछ लोड करता है:
        -   यह `app-config.js` से कॉन्फ़िगरेशन आयात करता है।
        -   यह फायरबेस सेवाओं को प्रारंभ करता है।
        -   यह सर्विस वर्कर को पंजीकृत करता है।

2.  **कंपोनेंट लोडिंग (`partial-loader.js`):**
    -   `app-loader.js` फिर `loadSmartPartials()` को कॉल करता है।
    -   यह फ़ंक्शन `partialsMap` में परिभाषित सभी HTML पार्शियल (जैसे हेडर, ड्रॉअर) को उनके प्लेसहोल्डर्स में इंजेक्ट करता है। यह इन पार्शियल के अंदर पाए गए किसी भी `<script type="module">` टैग को भी निष्पादित करता है, जिससे प्रत्येक कंपोनेंट का अपना एनकैप्सुलेटेड लॉजिक हो सकता है।

3.  **मुख्य ऐप लॉजिक (`main.js`):**
    -   एक बार जब सभी पार्शियल सफलतापूर्वक लोड हो जाते हैं, तो `app-loader.js` अंत में `main.js` को आयात करता है।
    -   `main.js` में `initializeApp()` फ़ंक्शन चलता है, जो `viewManager.init()` को कॉल करके ऐप के नेविगेशन और स्टेट मैनेजमेंट को प्रारंभ करता है और डेटा-निर्भर मॉड्यूल सेट करता है। `main.js` अब ऐप के नेविगेशन का "मस्तिष्क" है। यह URL हैश और उपयोगकर्ता की क्रियाओं के आधार पर प्रबंधित करता है कि कौन सा व्यू वर्तमान में दिखाई दे रहा है।
