...
`users.json` में पहले से ही कई परीक्षण उपयोगकर्ता (जैसे `super-admin`, `merchant`, `user`) परिभाषित हैं। व्यवस्थापक-संचालित परीक्षण के लिए, आप सीधे इन मौजूदा उपयोगकर्ताओं का उपयोग कर सकते हैं।
